...
public class OverlayDrawer extends DraggableDrawer {
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        super.addView(mContentContainer, -1, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
        if (USE_TRANSLATIONS) {
            mContentContainer.setLayerType(View.LAYER_TYPE_NONE, null);
        }
        mContentContainer.setHardwareLayersEnabled(false);
        super.addView(mMenuContainer, -1, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
        mPeekSize = dpToPx(20);
    }
...
//      mMenuOverlay.setAlpha((int) (MAX_MENU_OVERLAY_ALPHA * openRatio)); 4.0前系统无效
//      mMenuOverlay.draw(canvas);
        Paint p = new Paint();
        p.setColor(Color.BLACK);
        p.setAlpha((int) (MAX_MENU_OVERLAY_ALPHA * openRatio));
        canvas.drawRect(offsetPixels, 0, width, height,p);
    }
