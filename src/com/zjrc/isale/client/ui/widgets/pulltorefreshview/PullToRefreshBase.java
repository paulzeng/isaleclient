package com.zjrc.isale.client.ui.widgets.pulltorefreshview;

import com.zjrc.isale.client.R;
import com.zjrc.isale.client.ui.widgets.pulltorefreshview.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		/*
		 * if (a.hasValue(R.styleable.PullToRefresh_headerTextColor)) { final
		 * int color = a.getColor(R.styleable.PullToRefresh_headerTextColor,
		 * Color.BLACK); if (null != headerLayout) {
		 * headerLayout.setTextColor(color); } if (null != footerLayout) {
		 * footerLayout.setTextColor(color); } } if
		 * (a.hasValue(R.styleable.PullToRefresh_headerBackground)) {
		 * this.setBackgroundResource
		 * (a.getResourceId(R.styleable.PullToRefresh_headerBackground,
		 * Color.WHITE)); } if
		 * (a.hasValue(R.styleable.PullToRefresh_adapterViewBackground)) {
		 * refreshableView.setBackgroundResource(a.getResourceId(R.styleable.
		 * PullToRefresh_adapterViewBackground, Color.WHITE)); }
		 */
