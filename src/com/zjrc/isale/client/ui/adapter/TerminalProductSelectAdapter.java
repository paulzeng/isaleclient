...
public class TerminalProductSelectAdapter extends BaseAdapter {
	
	private LayoutInflater inflater;
	
	private List<ProductItem> list;
	
	public TerminalProductSelectAdapter(LayoutInflater inflater) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			view = inflater.inflate(R.layout.terminalproductselect_item, parent, false);
		}
	...
	public void addItem(String productid,String productname, String productbrandname, String productcategoryname,
