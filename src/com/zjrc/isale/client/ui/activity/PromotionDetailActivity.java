...
public class PromotionDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView tv_promotionbrand;
    private TextView tv_promotioncategory;
    private TextView tv_promotionnorm;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tv_promotionbrand = (TextView) findViewById(R.id.tv_promotionbrand);
        tv_promotioncategory = (TextView) findViewById(R.id.tv_promotioncategory);
        tv_promotionnorm = (TextView) findViewById(R.id.tv_promotionnorm);
    	...
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.iv_promotionphoto:
    			if (!TextUtils.isEmpty(photofilepath)) {
    				...
    				intent.setClass(PromotionDetailActivity.this, ImageViewActivity.class);
    ...
    private void sendQueryPromotionDetail(String id) {
        ...
        if (application != null) {
            ...
            params.put("promotionid", XmlValueUtil.encodeString(id));
            request("corppromotion!detail?code=" + Constant.PROMOTION_DETAIL, params, FLAG_SHOW_PROGRESS | FLAG_SHOW_ERROR | FLAG_CANCEL);
        }
    }
    ...
    public void onRecvData(JsonObject response) {
        if (response != null) {
            ...
            if (Constant.PROMOTION_DETAIL.equals(code)) {
                ...
                if (promotion != null) {
                    ...
                    tv_promotionbegindate.setText(promotion.get("begindate").getAsString());
                    tv_promotionenddate.setText(promotion.get("enddate").getAsString());
                    tv_promotionproduct.setText(promotion.get("productname").getAsString() );
                    tv_promotionbrand.setText( promotion.get("brandname").getAsString() );
                    tv_promotioncategory.setText(promotion.get("categoryname").getAsString());
                    tv_promotionnorm.setText(promotion.get("productnorm").getAsString());
                    ...
                    if (!isPhotoExists) {
                        ...
                        if (!TextUtils.isEmpty(photofileid)) {
                            ISaleApplication application = (ISaleApplication) getApplication();
                            if (application != null) {
                                downloadtask = new FileDownloadTask(application, PromotionDetailActivity.this, "promotion", photofileid, downloadeventlistener, false);
