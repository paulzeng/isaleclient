...
public class BackorderSearchActivity extends BaseActivity implements
	...
	private TextView tv_backorderstatus;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.backorder_search);
		...
		tv_backorderstatus = (TextView) findViewById(R.id.tv_backorderstatus);
		tv_backorderstatus.setOnClickListener(this);
		...
		if (bundle != null) {
			...
			tv_backorderdate.setText("");
			tv_backorderstatus.setText("");
			tv_backorderstatus
					.setTag("");
		}
	}
	...
	public void onClick(View view) {
		if (CommonUtils.isNotFastDoubleClick()) {
			...
			case R.id.btn_titlebar_barcode:
				Intent openCameraIntent = new Intent(BackorderSearchActivity.this,
						CaptureActivity.class);
				startActivityForResult(openCameraIntent, Constant.BARCODE_SCAN);
				break;
			case R.id.tv_backorderstatus:
				if (orderStatusDialog == null) {
					orderStatusDialog = new CustomPopupDialog(this, "状态",
							getResources().getStringArray(R.array.backorderstatus),
							new AdapterView.OnItemClickListener() {
						@Override
						public void onItemClick(AdapterView<?> parent,
								View view, int position, long id) {
							tv_backorderstatus.setText(((TextView) view)
									.getText());
							tv_backorderstatus.setTag(position);
			...
			case R.id.btn_ok:
				...
				bundle.putString("terminalcode", et_terminalcode.getText()
						.toString());
				bundle.putString("terminalname", et_terminalname.getText()
						.toString());
				bundle.putString("backorderdate", tv_backorderdate.getText()
						.toString());
				bundle.putString("backorderstatus", tv_backorderstatus.getText()
						.toString());
				bundle.putString("backorderstatus_index", tv_backorderstatus
						.getTag() != null ? tv_backorderstatus.getTag().toString()
								: "");
	...
	public boolean onTouch(final View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			datePicker = new CustomDatePicker(BackorderSearchActivity.this,
