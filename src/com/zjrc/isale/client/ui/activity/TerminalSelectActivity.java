...
import com.zjrc.isale.client.ui.adapter.TerminalSelectAdapter;
import com.zjrc.isale.client.ui.adapter.TerminalSelectAdapter.TerminalItem;
...
public class TerminalSelectActivity extends BaseActivity implements OnItemClickListener, PullToRefreshBase.OnRefreshListener, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terminalselect_list);
        ...
        tv_titlebar_title.setText(R.string.terminalselect_list);
        ...
        adapter = new TerminalSelectAdapter(getLayoutInflater());
    ...
    public void onClick(View view) {
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.btn_titlebar_filter:
    			intent = new Intent(TerminalSelectActivity.this, TerminalSearchActivity.class);
    			bundle = new Bundle();
    			...
    			startActivityForResult(intent, Constant.RESULT_TERMINALLIST_REFRESH);
    			break;
    		}
    	}
    }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        TerminalItem item = (TerminalItem) adapter.getItem(arg2 - 1);
        if (item != null) {
            Intent intent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString("terminalid", item.getTerminalid());
            bundle.putString("terminalname", item.getTerminalname());
            bundle.putString("terminaladdress", item.getTerminaladdress());
            bundle.putString("terminalman", item.getTerminalman());
            bundle.putString("terminalphone", item.getTerminalphone());
            intent.putExtras(bundle);
    ...
    public void onRefresh() {
        if (actualListView.getFirstVisiblePosition() == 0) {
            ...
            TerminalItem item = (TerminalItem) adapter.getItem(actualListView.getLastVisiblePosition() - 2);
            if (item != null) {
                id = item.getTerminalid();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constant.RESULT_TERMINALLIST_REFRESH) {
    ...
    public void sendQueryTerminal(String terminalid, String order, boolean needProgress) {
