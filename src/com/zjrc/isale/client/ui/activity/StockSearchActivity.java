 ...
 * 功能描述：库存信息搜索界面
 */
public class StockSearchActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onClick(View view) {
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.btn_titlebar_barcode:
    			Intent openCameraIntent = new Intent(StockSearchActivity.this, CaptureActivity.class);
    		...
    		case R.id.btn_ok:
    			...
    			bundle.putString("stockdate", tv_stockdate.getText().toString());
    ...
    public boolean onTouch(final View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
             	...
             	datePicker = new CustomDatePicker(StockSearchActivity.this,
