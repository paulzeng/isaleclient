...
public class PromotionListActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tv_titlebar_title.setText(R.string.promotion_list);
	...
	public void onClick(View view) {
		if (CommonUtils.isNotFastDoubleClick()) {
			...
			case R.id.btn_titlebar_filter:
				intent = new Intent(PromotionListActivity.this,
			...
			case R.id.btn_titlebar_add:
				...
				intent.putExtras(bundle);
				intent.setClass(PromotionListActivity.this,
						PromotionSubmitActivity.class);
				startActivityForResult(intent, Constant.PROMOTIONLIST_REFRESH);
				break;
			}
		}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		PromotionItem item = (PromotionItem) adapter.getItem(arg2 - 1);
		if (item != null) {
			Intent intent = new Intent(PromotionListActivity.this,
	...
	public void sendQueryPromotionList(String promotionid, String order,boolean needProgress) {
        ...
        if (application != null) {
            ...
            params.put("promotionid",  XmlValueUtil.encodeString(promotionid));
            params.put("promotiondate","");
            params.put("order",XmlValueUtil.encodeString(order));
            request("corppromotion!list?code=" + Constant.PROMOTION_LIST, params, FLAG_SHOW_PROGRESS | FLAG_SHOW_ERROR | FLAG_CANCEL);
        }
	}
    ...
    public void onRecvData(JsonObject response) {
        if (response != null) {
            ...
            if (Constant.PROMOTION_LIST.equals(code)) {
                ...
                if (orders != null) {
                    for (JsonElement ordersElem : orders) {
                        ...
                        adapter.addItem(ordersObj.get("id").getAsString(),
                                ...
                                ordersObj.get("desc").getAsString(),
