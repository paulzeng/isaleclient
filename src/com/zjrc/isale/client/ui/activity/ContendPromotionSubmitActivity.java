 ...
 * 功能描述：竞品活动上报界面
 */
public class ContendPromotionSubmitActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.contendpromotion_submit);
        ...
        tv_titlebar_title.setText(R.string.contendpromotion_submit);
    ...
    public void onClick(View view) {
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.btn_titlebar_barcode:
    			Intent openCameraIntent = new Intent(ContendPromotionSubmitActivity.this, com.zjrc.isale.client.zxing.activity.CaptureActivity.class);
    		...
    		case R.id.tv_promotionterminal:
    			...
    			intent.setClass(ContendPromotionSubmitActivity.this, TerminalSelectActivity.class);
    		...
    		case R.id.tv_promotionproduct:
    			if (TextUtils.isEmpty(terminalid) || TextUtils.isEmpty(terminalname)) {
    				...
    				intent.putExtras(bundle);
    				intent.setClass(ContendPromotionSubmitActivity.this, ContendProductSelectActivity.class);
    				startActivityForResult(intent, Constant.RESULT_PRODUCT_SELECT);
    			}
    			break;
    		case R.id.iv_takephoto:
                intent = new Intent();
                intent.setClass(ContendPromotionSubmitActivity.this, CaptureActivity.class);
            ...
            case R.id.iv_photo:
                if (!TextUtils.isEmpty(photofilepath)) {
                    ...
                    intent.putExtras(bundle);
                    intent.setClass(ContendPromotionSubmitActivity.this, ImageViewActivity.class);
...
//    			et_promotionphoto.setEnabled(false);
    			...
    			if (validityInput()) {
    				...
    				if (application != null) {
    					if (!TextUtils.isEmpty(photofilepath) && TextUtils.isEmpty(photofileid)) {
    						uploadtask = new FileUploadTask(application, ContendPromotionSubmitActivity.this, "promotion", photofilepath, et_promotionphoto.getText().toString(), uploadeventlistener);
    						uploadtask.execute();
    					} else {
    						sendSubmit();
    					}
    ...
    public boolean onTouch(final View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
    			datePicker = new CustomDatePicker(ContendPromotionSubmitActivity.this,
    ...
    private boolean validityInput() {
        if (TextUtils.isEmpty(terminalid)) {
            showAlertDialog("确认", "请选择活动网点!", new View.OnClickListener() {
 				@Override
 				public void onClick(View arg0) {
 					alertDialog.cancel();
 				}
        ...
        if (TextUtils.isEmpty(sPromotionEnddate)) {
            showAlertDialog("提示", "选择结束日期!", new View.OnClickListener() {
  				@Override
  				public void onClick(View arg0) {
  					alertDialog.cancel();
  				}
        ...
        if (TextUtils.isEmpty(contendproductid)) {
        ...
        if (TextUtils.isEmpty(sPromotionPrice)) {
            showAlertDialog("提示", "请输入活动价格!", new View.OnClickListener() {
  				@Override
  				public void onClick(View arg0) {
  					alertDialog.cancel();
  				}
        ...
        if (TextUtils.isEmpty(sPromotionNum)) {
            showAlertDialog("提示", "请输入活动数量!", new View.OnClickListener() {
  				@Override
  				public void onClick(View arg0) {
  					alertDialog.cancel();
  				}
            ...
            showAlertDialog("提示", "活动数量必须大于0，请重新输入!", new View.OnClickListener() {
                @Override
                public void onClick(View arg0) {
                    alertDialog.cancel();
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == Constant.BARCODE_SCAN) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                tv_promotionproduct.setText(contendproductname);
                et_promotionprice.setText(bundle.getString("contendproductprice"));
            }
...
//                et_promotionphoto.setEnabled(true);
    ...
    private void sendSubmit() {
        ...
        if (application != null) {
            ...
            params.put("contendproductid",XmlValueUtil.encodeString(contendproductid));
            ...
            params.put("contendpromotionid", "");
            request("corpcontendpromotion!submit?code=" + Constant.CONTENDPROMOTION_SUBMIT, params, FLAG_SHOW_PROGRESS | FLAG_SHOW_ERROR | FLAG_CANCEL);
        }
    }
    ...
    public void onRecvData(JsonObject response) {
    	if (response != null) {
            ...
            }else if(Constant.CONTENDPROMOTION_SUBMIT.equals(code)){
