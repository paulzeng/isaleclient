 ...
 * 功能描述：进店品项搜索界面
 */
public class TerminalProductSearchActivity extends BaseActivity implements
	...
	private TextView tv_intoterminaldate;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.terminalproduct_search);
		...
		tv_intoterminaldate = (TextView) findViewById(R.id.tv_intoterminaldate);
		tv_intoterminaldate.setOnTouchListener(this);
		...
		if (bundle != null) {
			...
			tv_intoterminaldate.setText(bundle.getString("intoterminaldate"));
		...
		if (CommonUtils.isNotFastDoubleClick()) {
			...
			case R.id.btn_titlebar_barcode:
				Intent openCameraIntent = new Intent(
						TerminalProductSearchActivity.this, CaptureActivity.class);
			...
			case R.id.btn_ok:
				...
				bundle.putString("terminalname", et_terminalname.getText()
						.toString());
				bundle.putString("intoterminaldate", tv_intoterminaldate.getText()
						.toString());
	...
	public boolean onTouch(final View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			datePicker = new CustomDatePicker(
					TerminalProductSearchActivity.this, "请输入进店品项时间",
