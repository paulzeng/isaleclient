...
public class PromotionSearchActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_promotiondesc = (TextView) findViewById(R.id.et_promotiondesc);
    ...
    public void onClick(View view) {
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.btn_titlebar_barcode:
    			Intent openCameraIntent = new Intent(PromotionSearchActivity.this, CaptureActivity.class);
    		...
    		case R.id.btn_ok:
    			...
    			bundle.putString("promotiondesc", et_promotiondesc.getText().toString());
...
//                
//				datePicker = new CustomDatePicker(PromotionSearchActivity.this,
//						"请输入销售活动时间", new View.OnClickListener() {
//
//							@Override
