 ...
 * 功能描述：销量信息搜索界面
 */
public class SaleSearchActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onClick(View view) {
    	if (CommonUtils.isNotFastDoubleClick()) {
    		...
    		case R.id.btn_titlebar_barcode:
    			Intent openCameraIntent = new Intent(SaleSearchActivity.this, com.zjrc.isale.client.zxing.activity.CaptureActivity.class);
    		...
    		case R.id.btn_ok:
    			...
    			bundle.putString("saledate", tv_saledate.getText().toString());
    ...
    public boolean onTouch(final View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
				...
				datePicker = new CustomDatePicker(SaleSearchActivity.this,
						"请销售时间", new View.OnClickListener() {
